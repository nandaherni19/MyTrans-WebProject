    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .left-panel .bg-image {
            position: absolute;
            inset: 0;
            background: url('https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=900&q=80') center/cover no-repeat;
            z-index: 0;
        }
        ...
        .btn-login:hover {
            ...
            box-shadow: 0 8px 20px rgba(30, 77, 183, 0.35);
        }

        .btn-login:active { transform: translateY(0); }

        .btn-login .arrow { font-size: 18px; }
        ...
        @media (max-width: 768px) {
            ...
            .left-panel .bottom-text { padding: 24px; }
            .bottom-text h2 { font-size: 20px; }
