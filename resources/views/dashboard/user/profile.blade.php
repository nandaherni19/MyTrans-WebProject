    ...
    <main class="profile-page">
            ...
            <div class="profile-hero-left">
                <div class="avatar-wrapper">
                    <div class="avatar-circle">
                        @if(!empty($user->photo))
                            <img src="{{ asset('storage/' . $user->photo) }}" alt="Foto Profil" class="avatar-image"
                                id="previewImage" onerror="
        ...
        <div id="panelPersonal">
            ...
            <div id="editPersonal" style="display:none;">
                <form action="{{ route('dashboard.user.profile-update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    @error('photo')
                        <small class="error-text" id="photoError">{{ $message }}</small>
                    @enderror
        ...
        <div id="panelPassword" style="display:none;">
            ...
            <div id="viewPassword">
                ...
                <section class="security-tip-card">
                    ...
                    <div class="security-text">
                        <h4>Tips Keamanan</h4>
                        <p>Untuk keamanan akun Anda, pastikan menggunakan password yang kuat dan tidak membagikan informasi
                            login Anda kepada siapapun.</p>
                    </div>
                </section>
            ...
            <div id="editPassword" style="display:none;">
                ...
                <section class="security-tip-card">
                    <div class="security-icon"><i class="fa-solid fa-shield"></i></div>
                    <div class="security-text">
                        <h4>Tips Keamanan</h4>
                        <p>Untuk keamanan akun Anda, pastikan menggunakan password yang kuat dan tidak membagikan informasi
                            login Anda kepada siapapun.</p>
...
@push('scripts')
    <script>
        ...
        // ── Enter Edit Mode ────────────────────────────────────────
        window.enterEditMode = function (tab) {

            isEditing = true;
            currentTab = tab;

            const labelPersonal =
                document.getElementById('labelPersonal');

            const labelPassword =
                document.getElementById('labelPassword');

            if (labelPersonal) {
                labelPersonal.textContent =
            ...
            if (tab === 'personal') {
                ...
                document.getElementById('viewPersonal')
        ...
        // ── Exit Edit Mode ─────────────────────────────────────────
        window.exitEditMode = function (tab) {
                ...
                photoInput.addEventListener('change', function (e) {
                    ...
                    reader.onload = function (event) {
                        ...
                        img.onload = function () {
                            ...
                            // Kompres jadi JPEG quality 70% (~20-50KB)
