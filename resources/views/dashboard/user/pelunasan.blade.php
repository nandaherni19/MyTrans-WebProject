...
<main class="pelunasan-page">
    ...
    <div class="pelunasan-card">
        ...
        <div class="actions">
            <button onclick="openQris()" class="btn-outline payment-choice" type="button" id="btnQris">
                Bayar via QRIS
            </button>

            <button onclick="openCash()" class="btn-outline payment-choice" type="button" id="btnCash">
                Bayar Cash
            </button>

            <a href="{{ route('dashboard.user.detailpesanan', ['booking', $booking->id_booking]) }}"
            class="btn-outline">
                Detail Pesanan
            </a>
        </div>
   ...
   <div id="cashModal" class="modal">
    <div class="modal-content">
        ...
        <a href="https://wa.me/6285664837559?text={{ urlencode($waMessage) }}"
        target="_blank"
        class="btn-primary"
