                    ...
                    <tbody>
                        @forelse($bookings as $booking)
                            ...
                            <tr class="transaksi-row"
                                    ...
                                    @elseif($refundDiproses)
                                        ...
                                        <div>
                                            <span style="color: #b45309; font-weight: 600; display:block;">
                                                Rp {{ number_format($refundDiproses->jumlah_refund ?? $estimasiRefund, 0, ',', '.') }}
                                            </span>
                                ...
                                <td style="color: #475569; text-transform: uppercase; font-size: 12px; font-weight: 600; letter-spacing: 0.3px;">
                                    {{ optional($pembayaranTerakhir)->metode_pembayaran ?? '-' }}
                                </td>
                            </tr>
                        @empty
...
function exportCSV() {
    ...
    let url       = "{{ route('dashboard.superadmin.kelola-laporan-transaksi.export') }}";
    if (dari && sampai) {
