    ...
    <section class="profile-hero-card">
        <div class="avatar-wrapper">
            <div class="avatar-circle">
                @if(!empty($user->photo))
                    <img src="{{ asset('storage/' . $user->photo) }}" alt="Foto Profil" class="avatar-image" id="previewImage"
            ...
            <label for="photoInputForm" class="camera-icon" id="cameraLabel" style="display:none;">
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const photoInput = document.getElementById('photoInputForm');
