...
@section('content')
            ...
            <div class="paket-grid">
                @forelse($pakets as $paket)
                    <div class="paket-card">
                        <img src="{{ $paket->gambar ? asset('storage/' . $paket->gambar) : asset('img/default.png') }}"
                            alt="paket">
                        ...
                        <div class="paket-body">
                            ...
                            <div class="paket-actions">
                                ...
                                <button type="button" class="btn-delete" onclick="openHapus('{{ $paket->id_paket }}')">
    ...
    <div class="modal-overlay" id="modalTambah">
        <div class="tambah-modal">
            ...
            <form action="{{ route('dashboard.superadmin.kelola-paket-wisata.store') }}" method="POST"
        ...
        <div class="tambah-modal">
            ...
            <form id="editForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="tambah-grid">
                    <div class="tambah-group">
                        <label>Fasilitas yang didapatkan</label>
                        <textarea class="auto-textarea" id="editFasilitas" name="fasilitas"
                            oninput="autoResize(this)"></textarea>
                    </div>

                    <div class="tambah-group">
                        <label>Deskripsi Paket Wisata</label>
                        <textarea class="auto-textarea" id="editDeskripsi" name="deskripsi"
                            oninput="autoResize(this)"></textarea>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const gambarInputs = document.querySelectorAll('input[name="gambar"]');

            gambarInputs.forEach(function (gambarInput) {
                ...
                gambarInput.addEventListener('change', function (e) {
                    ...
                    reader.onload = function (event) {
                        ...
                        img.onload = function () {
                            ...
                            // Resize proporsional max 800x800
                            let width = img.width;
