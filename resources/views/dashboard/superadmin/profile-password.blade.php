...
@section('navbar_action')
    <a href="{{ route('dashboard.superadmin.profile') }}" class="btn-kembali">← Kembali</a>
@endsection
...
@endif
    ...
    <section class="profile-tabs">
        <a href="{{ route('dashboard.superadmin.profile') }}" class="tab-btn">Informasi Pribadi</a>
        <a href="{{ route('dashboard.superadmin.profile-password') }}" class="tab-btn active">Password</a>
    </section>
