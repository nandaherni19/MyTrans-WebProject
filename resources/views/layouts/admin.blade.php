...
<body>
    ...
    <div id="modal-logout">
        <div class="modal-logout-box">
            ...
            <p>Anda akan keluar dari sesi ini.<br>Pastikan semua aktivitas sudah tersimpan.</p>
            <div class="modal-logout-actions">
                <button class="btn-logout-cancel" onclick="tutupModalLogout()">Batal</button>
                <button class="btn-logout-confirm" onclick="document.getElementById('form-logout').submit()">Ya,
                    Keluar</button>
            </div>
        </div>
    </div>
